...
const GithubIcon = () => {
  return (
    <svg
      ...
      className={
        "size-8 stroke-white hover:stroke-secondary transition-all duration-200"
      }
    >
      <title>GitHub</title>
...
const LinkedInIcon = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="size-8 stroke-white hover:stroke-secondary transition-all duration-200"
    >
...
const ItchIcon = () => {
  return (
    <svg
      ...
      className="size-8 fill-white stroke-white hover:stroke-secondary hover:fill-secondary transition-all duration-200"
    >
...
const mediaInfo = [
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/bruce-peters-17a10931b/",
    icon: <LinkedInIcon />,
  },
  {
    name: "Itch",
    link: "https://bobcat9.itch.io/",
    icon: <ItchIcon />,
  },
];
